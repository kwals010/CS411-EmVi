...
?>
	...
	if ($ftypename == 'html' || $ftypename == 'txt') {
		echo '<form><input type="button" value="Hot Edit Content" style="background-color:#c00; color:#fff;" ONCLICK="window.open(\''.$siteUrl .'pages/ckeditor.php?name='.$fileloc.'.'.$ftypename.'\');" ></form></td></tr>
