...
$sidebar["useredit"] = array("pos"=>"left","size"=>2,"full_height"=>false/*<- this sets wether the sidebar should be the full page height or not*/,
	
);

$sidebar["regHelp"] = array("pos"=>"left","size"=>2,"full_height"=>false/*<- this sets wether the sidebar should be the full page height or not*/,
	
);

$sidebar["addcontent"] = array("pos"=>"left","size"=>2,"full_height"=>false/*<- this sets wether the sidebar should be the full page height or not*/,

);

$sidebar["editcontent"] = array("pos"=>"left","size"=>2,"full_height"=>false/*<- this sets wether the sidebar should be the full page height or not*/,

);

$sidebar["addcampaign"] = array("pos"=>"left","size"=>2,"full_height"=>false/*<- this sets wether the sidebar should be the full page height or not*/,
