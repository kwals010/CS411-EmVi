...
/* Tilegroup settings */
if ($user['userRole'] == 1){
	$groupTitles = array('My Work','Campaigns','Emails','Search','My Account','Help','Administration',); // titles of the tileGroups
}else{
	$groupTitles = array('My Work','Campaigns','Emails','Search','My Account','Help',); // titles of the tileGroups
