...
<h1 class="margin-t-0">Content Search</h1>
 ...
 if (isset($_GET['Type'])){
 	...
 	$search = new Search();
	$found = $search->get_content($_GET['Type'], $_GET['Field'], $_GET['Value'],$orderby,$dir);
...
header('Location: '.$siteUrl.'member.php#!/url=search/searchcontent.php?Type='.$type.'&Field='.$field.'&Value='.$word);
