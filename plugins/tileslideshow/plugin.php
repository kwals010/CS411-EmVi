...
function tile_slideshow($group,$x,$y,$width,$height,$background,$url,$images,$texts,$effect,$speed,$arrows,$labelText,$labelColor,$labelPosition,$classes){
    ...
    <script>slideshowTiles["tileSlideshow<?php echo $id?>"] = [<?php echo json_encode($images)?>,<?php echo json_encode($texts);?>,<?php echo '"'.$effect.'"';?>,<?php echo $speed?>]</script>
